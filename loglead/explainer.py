...
class ShapExplainer:
    ...
    def calc_shapvalues(self, test_data=None, custom_slice:slice=None):
        ...
        if self.istree:
            ...
            # tree gives two sets of values which are "mirrored"
    ...
    def plot(self, data:np.ndarray=None,plottype="summary", custom_slice:slice=None, displayed=16):
        ...
        # no colors due to data being "O" data type
        if plottype == "summary":
            shap.summary_plot(self.Svals, plotdata,feature_names=self._truncatefn(displayed), max_display=displayed)
        # does not have a way to add feature names. Could be done but a bit complicated.
        elif plottype == "bar":
        ...
        # create new elif for new plot
            ...
            # for example summary_plot uses the dataset
